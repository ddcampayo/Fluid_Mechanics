...
\[
\frac{L}{H} = -4\pi R \rho u_0^2 \sin(\theta_\text{st}) ,
\]
with the prediction that the lift force will increase quadratically with speed.
The minus sign should not cause concern, since the angles are negative for
positive circulation. Notice there is also a prediction of a maximum lift force,
