...
Recalling the definition of the strain tensor $\epsilon$ \ref{eq:},
\begin{equation*}
  \rho \frac{d\bfu }{dt} =
  - \nabla p +
  \mu \nabla \cdot  ( \nabla\bfu + \nabla\bfu^t )
...
pure shear flow.
%symmetric, traceless tensor. For any tensor $T$, this operation
%constist of a symmetrization, $T+T^t$, and then substracting the
%trace, $T+T'-2\mathbf{Tr}(T)$. The trace of
