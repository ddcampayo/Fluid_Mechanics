...
\glsxtrnewsymbol[description={generic field}]{A}{A}
...
\glsxtrnewsymbol[description={mass of a particle/mass within a parcel}]{mass}{\ensuremath{m}}
\glsxtrnewsymbol[description={volume of a particle/volume of a parcel}]{vol}{\ensuremath{V}}
...
\glsxtrnewsymbol[description={strain rate tensor, specific energy,
Levi-Civita symbol}]{epsilon}{$\epsilon$}
\glsxtrnewsymbol[description={shear stress tensor}]{tau}{$\tau$}

\glsxtrnewsymbol[description={velocity potential, azimuthal angle in cylindrical and spherical coordinates}]{phi}{$\phi$}
\glsxtrnewsymbol[description={stream function}]{psi}{$\psi$}

\glsxtrnewsymbol[description={gravitational potential}]{varphi}{$\varphi$}
